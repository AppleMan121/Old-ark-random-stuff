...
bool ImGui::tab(const char* icon, const char* label, const ImVec2& size_arg, const bool selected)
{
    ...
    if (selected)
        draw->AddRectFilledMultiColor(ImVec2(bb.Min), ImVec2(bb.Min.x + 1.5f, bb.Max.y), ImColor(255, 69, 0), ImColor(255, 69, 0), ImColor(255, 69, 0), ImColor(255, 69, 0));


    ImGui::PushFont(zzzz);
    window->DrawList->AddText(ImVec2(bb.Min.x + size_arg.x / 2 - ImGui::CalcTextSize(label).x / 2, bb.Min.y + size_arg.y / 2 - ImGui::CalcTextSize(label).y / 2 + 15), ImColor(255 / 255.f, 69 / 255.f, 0 / 255.f, 255.f / 255.f), label);
    ImGui::PopFont();
...
bool ImGui::sub(const char* label, bool selected)
{
    ...
    if (selected)
    {
        window->DrawList->AddText(ImVec2(bb.Min.x + size.x / 2 - ImGui::CalcTextSize(label).x / 2, bb.Min.y + size.y / 2 - ImGui::CalcTextSize(label).y / 2), ImColor(255 / 255.f, 69 / 255.f, 0 / 255.f, 255.f / 255.f), label);
    }
    else
    {
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
        window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + 5, check_bb.Min.y + 3), ImVec2(check_bb.Max.x, check_bb.Max.y - 2), ImColor(255.f / 255.f, 69.f / 255.f, 0.f / 255.f, 255.f / 255.f), 24.f);
    else
